...
menuscreen.run = function()
	...
	rendering.genericColorTween(script.Parent.Parent.Parent.Parent.gry.overlay, Color3.new(0.501961, 0.596078, 0.784314), 10, function()
		...
		local box = engine.dialogueBox("font3_dark", true, "", dialogue.battery.a, false, maxY-40, txtbox, function(txt, bx)
			txt:Destroy()
			bx:Destroy()
			local newbox = engine.dialogueBox("font3_dark", true, "", dialogue.battery.b, true, maxY-40, txtbox, function(txt, bx)
				txt:Destroy()
				bx:Destroy()
